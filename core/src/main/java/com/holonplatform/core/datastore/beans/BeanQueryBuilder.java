...
public interface BeanQueryBuilder<Q extends BeanQueryBuilder<Q>>
	 ...
	 * {@code offset = page * pageSize}. This is the preferred pagination strategy: it issues a single
	 * data-fetching query and <strong>never</strong> triggers a count query automatically.
	 * Use {@link com.holonplatform.core.datastore.beans.BeanQuery#count()} explicitly when a total
	 * count is actually required.
	 * </p>
